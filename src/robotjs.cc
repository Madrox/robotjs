...
int CheckKeyFlags(char *f, MMKeyFlags *flags)
{
	...
	else if (strcmp(f, "right_alt") == 0)
	{
		*flags = MOD_ALT | MOD_RIGHT;
	}
	else if (strcmp(f, "command") == 0)
	{
		*flags = MOD_META;
	}
	else if (strcmp(f, "control") == 0 || strcmp(f, "left_control") == 0)
	{
		*flags = MOD_CONTROL;
	}
	else if (strcmp(f, "right_control") == 0)
	{
		*flags = MOD_CONTROL | MOD_RIGHT;
	}
	else if (strcmp(f, "right_shift") == 0)
	{
		*flags = MOD_SHIFT | MOD_RIGHT;
	}
